...
let
  user      = "admin";
  password  = "password";
  hostname  = "6929275ea69fd0ee6da2ab3d";
  homeDir   = "/home/${user}";
          ...
          / {
            ...
            fragment@0 {
              ...
              __overlay__ {
                ...
                can0: can0@0 {
                  compatible = "microchip,mcp2518fd", "microchip,mcp251xfd";
                  reg = <0>;                      /* CS0 on spi0 */
                  spi-max-frequency = <8000000>;   /* 8 MHz is safe */

                  interrupt-parent = <&gpio>;
                  /* <GPIO  IRQ_TYPE_LEVEL_LOW>, 8 == IRQ_TYPE_LEVEL_LOW */
                  interrupts = <25 8>;
            ...
            /* 40 MHz crystal for the MCP2518FD */
            fragment@1 {
              target-path = "/";
              __overlay__ {
                can0_osc: can0_osc {
